...
const translations = {
  en: {
    ...
    legalNoticeBody: "VitalTrek is a student project developed by Nexum Devs for the course 1ASI0730 Aplicaciones Web at Universidad Peruana de Ciencias Aplicadas. It is a minimum viable product built for academic evaluation. It is not a commercial service, no real expedition is monitored through it, and this document is an academic exercise in drafting service terms — not legal advice.",
    ...
    terms8BodyA: "The VitalTrek name, interface, source code and documentation were produced by the Nexum Devs team as academic work. Third-party fonts, libraries and assets remain under their own licences.",
    ...
    terms12BodyA: "Questions about these Terms can be sent to the Nexum Devs team through the contact section of this site.",
    ...
    privacy1BodyA: "This Policy explains how the Nexum Devs team would handle personal data in the VitalTrek platform and on this website. It follows the principles of Peru's Ley N.° 29733, Ley de Protección de Datos Personales, and its regulations.",
    ...
    privacy8BodyB: "Requests should be addressed to the operator that organized the expedition, which can reach the Nexum Devs team through this site.",
    ...
    privacy12BodyA: "Questions about this Policy can be sent to the Nexum Devs team through the contact section of this site.",
  },
  ...
  es: {
    ...
    member3Name: "Ariel Mendoza",
    member3Role: "Ingeniería de Software",
    member4Name: "Miler Rodriguez",
    ...
    legalNoticeBody: "VitalTrek es un proyecto estudiantil desarrollado por Nexum Devs para el curso 1ASI0730 Aplicaciones Web de la Universidad Peruana de Ciencias Aplicadas. Es un producto mínimo viable creado para evaluación académica. No es un servicio comercial, no se monitorea ninguna expedición real a través de él, y este documento es un ejercicio académico de redacción de términos de servicio, no asesoría legal.",
    ...
    terms8BodyA: "El nombre VitalTrek, la interfaz, el código fuente y la documentación fueron elaborados por el equipo Nexum Devs como trabajo académico. Las tipografías, bibliotecas y recursos de terceros se mantienen bajo sus propias licencias.",
    ...
    terms12BodyA: "Las consultas sobre estos Términos pueden enviarse al equipo Nexum Devs a través de la sección de contacto de este sitio.",
    ...
    privacy1BodyA: "Esta Política explica cómo el equipo Nexum Devs trataría los datos personales en la plataforma VitalTrek y en este sitio web. Sigue los principios de la Ley N.° 29733, Ley de Protección de Datos Personales del Perú, y su reglamento.",
    ...
    privacy8BodyB: "Las solicitudes deben dirigirse al operador que organizó la expedición, quien puede contactar al equipo Nexum Devs a través de este sitio.",
    ...
    privacy12BodyA: "Las consultas sobre esta Política pueden enviarse al equipo Nexum Devs a través de la sección de contacto de este sitio.",
  },
};
