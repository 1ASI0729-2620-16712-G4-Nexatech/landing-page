...
const translations = {
  en: {
    ...
    member2Bio: "Works on the landing page and keeps its content available in both English and Spanish.",
  ...
  es: {
    ...
    member2Bio: "Trabaja en el landing page y mantiene su contenido disponible en inglés y español.",
    member3Name: "Ariel Mendoza",
